...
- **Missing:** the original research. The reachable write-up is SecurityAffairs summarising someone else's count, and it is unclear whether this is a distinct campaign or a re-count of ClawHavoc (`RADAR-2026-0002`).
...
- The `atool` / AntV campaign (19 May 2026) is now `RADAR-2026-0007`.
- `CVE-2026-45321` and the TanStack package list are folded into `RADAR-2026-0006`, from TanStack's own postmortem and maintainer issue.
- GlassWorm wave 5's MCP server is now `RADAR-2026-0008`, and its 72 Open VSX impersonation extensions are `RADAR-2026-0009`. `RADAR-2025-0011` was upgraded from a four-extension partial list to Koi's full fifteen-entry wave-1 IOC list.
