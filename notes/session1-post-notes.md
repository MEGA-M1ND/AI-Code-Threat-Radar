...
## 0. Lead with this one — `RADAR-2026-0007`
...
- Companion for the same post: `RADAR-2026-0005`, the August wave, does the same thing to `.claude/settings.json` from a different actor. Once is a trick, twice is a technique.


## 1. The first malware that used AI coding agents as its recon tool — `RADAR-2025-0008`
...
## 2. A worm that installs its own MCP server in your editor — `RADAR-2026-0001`
...
## 3. A marketplace where 12% of everything was malware — `RADAR-2026-0002`
...
- Related and separate: Snyk's `clawdhub` campaign (`RADAR-2026-0003`), where the malicious skill impersonated ClawHub's own CLI — 7,743 downloads before removal.

## 4. One line of code — `RADAR-2025-0001`
...
## 5. Malware that now lives in `.claude/` — `RADAR-2026-0005`
...
- Three separate incidents here (`RADAR-2025-0008`, `RADAR-2026-0001`, `RADAR-2026-0005`) treat the AI agent as infrastructure to be used rather than as a target to be attacked. That is the shift worth naming.
...
## Also worth a paragraph — `RADAR-2026-0010`, still live
