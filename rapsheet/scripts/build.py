#!/usr/bin/env python3
"""Validate every Rapsheet entry, then build the published artifacts into dist/.
...
ATTRIBUTION = f"Rapsheet ({HOMEPAGE}), CC BY 4.0"
